...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Supplier supplier;
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        var productId = idField.getText();
        if(productId.isEmpty()){
            JOptionPane.showMessageDialog(this, "Please add a Product ID");
            return;
        }
        Product product = supplier.getProductCatalog().searchProduct(Integer.parseInt(productId));
        if(product == null){
        ...
        workArea.add("ViewProductDetailJPanelSupplier", viewpanel);
